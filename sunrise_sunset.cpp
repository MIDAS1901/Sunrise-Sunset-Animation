...
void move_right(){
    ...
    if(x==8834){
        ...
        sun_spin=0;
        flag=0;
        sun_spin=0; sun_spin2=0;
        sun_xpos=500; sun_ypos=0;
        sun_color = 0.3; sky_color1 = 0.0; sky_color2 = 0.15;
    }
...
int main(int argc, char** argv){
	...
	cout<<"1. Use the left mouse button to start/resume the animation\n"
        <<"2. Use the right mouse button to pause the animation\n\n";
    cout<<"Created By Navneet Das 3231\n";
	init();
    glutMouseFunc(mouse);
	glutMainLoop();
}
